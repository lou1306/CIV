...
public partial class CcsParser : Parser {
	...
	static CcsParser() {
		...
		public CcsParser(ITokenStream input) : this(input, Console.Out, Console.Error) { }

		public CcsParser(ITokenStream input, TextWriter output, TextWriter errorOutput)
	...
	[RuleVersion(0)]
	public SetDefContext setDef() {
		SetDefContext _localctx = new SetDefContext(Context, State);
	...
	private ProcessContext process(int _p) {
		...
		ProcessContext _localctx = new ProcessContext(Context, _parentState);
	...
	[RuleVersion(0)]
	public RelabelExpressionContext relabelExpression() {
		RelabelExpressionContext _localctx = new RelabelExpressionContext(Context, State);
	...
	private RelabelListContext relabelList(int _p) {
		ParserRuleContext _parentctx = Context;
		int _parentState = State;
		RelabelListContext _localctx = new RelabelListContext(Context, _parentState);
	...
	[RuleVersion(0)]
	public RelabelContext relabel() {
		RelabelContext _localctx = new RelabelContext(Context, State);
	...
	[RuleVersion(0)]
	public SetIdContext setId() {
		SetIdContext _localctx = new SetIdContext(Context, State);
	...
	private SetListContext setList(int _p) {
		ParserRuleContext _parentctx = Context;
		int _parentState = State;
		SetListContext _localctx = new SetListContext(Context, _parentState);
	...
	[RuleVersion(0)]
	public NonTauActionContext nonTauAction() {
		NonTauActionContext _localctx = new NonTauActionContext(Context, State);
	...
	private static char[] _serializedATN = {
		...
		'\x5964', '\x3', '\x19', '\x94', '\x4', '\x2', '\t', '\x2', '\x4', '\x3', 
		...
		'\x2', '\x2', '\x2', '\x30', '\x33', '\x5', '\n', '\x6', '\x2', '\x31', 
		'\x33', '\x5', '\f', '\a', '\x2', '\x32', '\x30', '\x3', '\x2', '\x2', 
		'\x2', '\x32', '\x31', '\x3', '\x2', '\x2', '\x2', '\x33', '\a', '\x3', 
		'\x2', '\x2', '\x2', '\x34', '\x35', '\a', '\x17', '\x2', '\x2', '\x35', 
		'\t', '\x3', '\x2', '\x2', '\x2', '\x36', '\x37', '\a', '\x18', '\x2', 
		'\x2', '\x37', '\x38', '\a', '\a', '\x2', '\x2', '\x38', '\x39', '\x5', 
		'\xE', '\b', '\x2', '\x39', ':', '\a', '\x3', '\x2', '\x2', ':', '\v', 
		'\x3', '\x2', '\x2', '\x2', ';', '<', '\a', '\xF', '\x2', '\x2', '<', 
		'=', '\a', '\x18', '\x2', '\x2', '=', '>', '\a', '\a', '\x2', '\x2', '>', 
		'?', '\x5', '\x1E', '\x10', '\x2', '?', '@', '\a', '\x3', '\x2', '\x2', 
		'@', '\r', '\x3', '\x2', '\x2', '\x2', '\x41', '\x42', '\b', '\b', '\x1', 
		'\x2', '\x42', '\x43', '\a', '\x10', '\x2', '\x2', '\x43', '\x44', '\x5', 
		'\xE', '\b', '\x2', '\x44', '\x45', '\a', '\x11', '\x2', '\x2', '\x45', 
		'M', '\x3', '\x2', '\x2', '\x2', '\x46', 'G', '\x5', '\x10', '\t', '\x2', 
		'G', 'H', '\a', '\t', '\x2', '\x2', 'H', 'I', '\x5', '\xE', '\b', '\a', 
		'I', 'M', '\x3', '\x2', '\x2', '\x2', 'J', 'M', '\x5', '\x12', '\n', '\x2', 
		'K', 'M', '\a', '\x4', '\x2', '\x2', 'L', '\x41', '\x3', '\x2', '\x2', 
		'\x2', 'L', '\x46', '\x3', '\x2', '\x2', '\x2', 'L', 'J', '\x3', '\x2', 
		'\x2', '\x2', 'L', 'K', '\x3', '\x2', '\x2', '\x2', 'M', '^', '\x3', '\x2', 
		'\x2', '\x2', 'N', 'O', '\f', '\x6', '\x2', '\x2', 'O', 'P', '\a', '\b', 
		'\x2', '\x2', 'P', ']', '\x5', '\xE', '\b', '\a', 'Q', 'R', '\f', '\x5', 
		'\x2', '\x2', 'R', 'S', '\a', '\n', '\x2', '\x2', 'S', ']', '\x5', '\xE', 
		'\b', '\x6', 'T', 'U', '\f', '\n', '\x2', '\x2', 'U', ']', '\x5', '\x14', 
		'\v', '\x2', 'V', 'W', '\f', '\t', '\x2', '\x2', 'W', 'X', '\a', '\x14', 
		'\x2', '\x2', 'X', ']', '\x5', '\x1C', '\xF', '\x2', 'Y', 'Z', '\f', '\b', 
		'\x2', '\x2', 'Z', '[', '\a', '\x14', '\x2', '\x2', '[', ']', '\x5', '\x1E', 
		'\x10', '\x2', '\\', 'N', '\x3', '\x2', '\x2', '\x2', '\\', 'Q', '\x3', 
		'\x2', '\x2', '\x2', '\\', 'T', '\x3', '\x2', '\x2', '\x2', '\\', 'V', 
		'\x3', '\x2', '\x2', '\x2', '\\', 'Y', '\x3', '\x2', '\x2', '\x2', ']', 
		'`', '\x3', '\x2', '\x2', '\x2', '^', '\\', '\x3', '\x2', '\x2', '\x2', 
		'^', '_', '\x3', '\x2', '\x2', '\x2', '_', '\xF', '\x3', '\x2', '\x2', 
		'\x2', '`', '^', '\x3', '\x2', '\x2', '\x2', '\x61', '\x62', '\t', '\x2', 
		'\x2', '\x2', '\x62', '\x11', '\x3', '\x2', '\x2', '\x2', '\x63', '\x64', 
		'\a', '\x18', '\x2', '\x2', '\x64', '\x13', '\x3', '\x2', '\x2', '\x2', 
		'\x65', '\x66', '\a', '\x12', '\x2', '\x2', '\x66', 'g', '\x5', '\x16', 
		'\f', '\x2', 'g', 'h', '\a', '\x13', '\x2', '\x2', 'h', '\x15', '\x3', 
		'\x2', '\x2', '\x2', 'i', 'j', '\b', '\f', '\x1', '\x2', 'j', 'k', '\x5', 
		'\x18', '\r', '\x2', 'k', 'q', '\x3', '\x2', '\x2', '\x2', 'l', 'm', '\f', 
		'\x3', '\x2', '\x2', 'm', 'n', '\a', '\x5', '\x2', '\x2', 'n', 'p', '\x5', 
		'\x18', '\r', '\x2', 'o', 'l', '\x3', '\x2', '\x2', '\x2', 'p', 's', '\x3', 
		'\x2', '\x2', '\x2', 'q', 'o', '\x3', '\x2', '\x2', '\x2', 'q', 'r', '\x3', 
		'\x2', '\x2', '\x2', 'r', '\x17', '\x3', '\x2', '\x2', '\x2', 's', 'q', 
		'\x3', '\x2', '\x2', '\x2', 't', 'u', '\x5', '\"', '\x12', '\x2', 'u', 
		'v', '\a', '\x6', '\x2', '\x2', 'v', 'w', '\x5', '$', '\x13', '\x2', 'w', 
		'\x19', '\x3', '\x2', '\x2', '\x2', 'x', '{', '\x5', '\x1C', '\xF', '\x2', 
		'y', '{', '\x5', '\x1E', '\x10', '\x2', 'z', 'x', '\x3', '\x2', '\x2', 
		'\x2', 'z', 'y', '\x3', '\x2', '\x2', '\x2', '{', '\x1B', '\x3', '\x2', 
		'\x2', '\x2', '|', '}', '\a', '\x18', '\x2', '\x2', '}', '\x1D', '\x3', 
		'\x2', '\x2', '\x2', '~', '\x7F', '\a', '\f', '\x2', '\x2', '\x7F', '\x80', 
		'\x5', ' ', '\x11', '\x2', '\x80', '\x81', '\a', '\r', '\x2', '\x2', '\x81', 
		'\x1F', '\x3', '\x2', '\x2', '\x2', '\x82', '\x83', '\b', '\x11', '\x1', 
		'\x2', '\x83', '\x84', '\x5', '$', '\x13', '\x2', '\x84', '\x8A', '\x3', 
		'\x2', '\x2', '\x2', '\x85', '\x86', '\f', '\x3', '\x2', '\x2', '\x86', 
		'\x87', '\a', '\x5', '\x2', '\x2', '\x87', '\x89', '\x5', '$', '\x13', 
		'\x2', '\x88', '\x85', '\x3', '\x2', '\x2', '\x2', '\x89', '\x8C', '\x3', 
		'\x2', '\x2', '\x2', '\x8A', '\x88', '\x3', '\x2', '\x2', '\x2', '\x8A', 
		'\x8B', '\x3', '\x2', '\x2', '\x2', '\x8B', '!', '\x3', '\x2', '\x2', 
		'\x2', '\x8C', '\x8A', '\x3', '\x2', '\x2', '\x2', '\x8D', '\x90', '\a', 
		'\v', '\x2', '\x2', '\x8E', '\x90', '\x5', '$', '\x13', '\x2', '\x8F', 
		'\x8D', '\x3', '\x2', '\x2', '\x2', '\x8F', '\x8E', '\x3', '\x2', '\x2', 
		'\x2', '\x90', '#', '\x3', '\x2', '\x2', '\x2', '\x91', '\x92', '\a', 
		'\x16', '\x2', '\x2', '\x92', '%', '\x3', '\x2', '\x2', '\x2', '\f', ')', 
		'.', '\x32', 'L', '\\', '^', 'q', 'z', '\x8A', '\x8F',
	};
